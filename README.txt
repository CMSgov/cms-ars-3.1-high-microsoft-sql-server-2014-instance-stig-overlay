cms-ars-3.1-high-microsoft-sql-server-2014-instance-stig-overlay
================================================================

InSpec profile overlay to validate the secure configuration of Microsoft
SQL Server 2014 Instance against
[DISA's](https://iase.disa.mil/stigs/Pages/index.aspx) Microsoft SQL
Server 2014 Instance STIG Version 1 Release 9 tailored for [CMS ARS
...
[issue](https://github.cms.gov/ispg/cms-ars-3.1-high-microsoft-sql-server-2014-instance-stig-overlay/issues/new).
